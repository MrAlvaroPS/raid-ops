...
| Per-route frontend behaviour | `raid-ops`, as each route passes its slice gate | Composition, Damage & Healing and Pull Lab transferred; eight routes pending | Functional, data, visual, documentation and rollback gates pass |
