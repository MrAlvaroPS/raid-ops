...
| Per-route frontend behaviour              | `raid-ops`, as each route passes its slice gate             | Defensive Audit, Progress, Pull Lab, Damage & Healing, Players and Composition transferred; five routes pending | Functional, data, visual, documentation and rollback gates pass |
