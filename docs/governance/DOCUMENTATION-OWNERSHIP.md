...
| Per-route frontend behaviour              | `raid-ops`, as each route passes its slice gate             | Command Center, Defensive Audit, Progress, Pull Lab, Damage & Healing, Players and Composition transferred; four routes pending | Functional, data, visual, documentation and rollback gates pass |
